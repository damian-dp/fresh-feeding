...
function CalendarDays(props) {
	...
	<g fill={fill}>
		...
		<path d="M9,8.25c-.551,0-1,.449-1,1s.449,1,1,1,1-.449,1-1-.449-1-1-1Z" fill={secondaryfill} stroke="none"/>
		<path d="M12.5,10.25c.551,0,1-.449,1-1s-.449-1-1-1-1,.449-1,1,.449,1,1,1Z" fill={secondaryfill} stroke="none"/>
		<path d="M9,11.25c-.551,0-1,.449-1,1s.449,1,1,1,1-.449,1-1-.449-1-1-1Z" fill={secondaryfill} stroke="none"/>
		<path d="M5.5,11.25c-.551,0-1,.449-1,1s.449,1,1,1,1-.449,1-1-.449-1-1-1Z" fill={secondaryfill} stroke="none"/>
		<path d="M12.5,11.25c-.551,0-1,.449-1,1s.449,1,1,1,1-.449,1-1-.449-1-1-1Z" fill={secondaryfill} stroke="none"/>
	</g>
</svg>
	);
};
