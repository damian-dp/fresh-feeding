...
export function DogProfilePage() {
  ...
  const currentPercent = getCurrentIntakePercent(dog);
  const intakeGrams = getDailyIntakeGrams(dog.weight_metric, currentPercent);
  const puppyMode = isEffectivePuppyMode(dog);
                ...
                {puppyMode ? (
                  <>
                    <p className="sm:-mt-[0.2em] sm:-mb-[0.15em]">
                      To help{" "}
                      <span className="text-foreground">{dog.dog_name}</span>{" "}
                      grow, they should be fed{" "}
                      <span className="whitespace-nowrap text-foreground">
                        {new Intl.NumberFormat().format(intakeGrams)}g
                      </span>{" "}
                      per day.
                    </p>
                    <Alert variant="warning" className="mt-2">
                      <AlertDescription>
                        Puppies (including small/working breeds) may need
                        adjustments during growth spurts. Monitor body condition
                  ...
                  <>
                    ...
                    {dog.ratios_intake === 3 && (
                      <p className="sm:-mt-[0.2em] sm:-mb-[0.15em]">
                        To help{" "}
                        <span className="text-foreground">{dog.dog_name}</span>{" "}
                        increase weight from their current weight of{" "}
                        <span className="text-foreground">
                          {dog.weight_metric}kg
                        </span>
                        , they should be fed{" "}
                    ...
                    {dog.ratios_intake === 2 && (
                      <p className="sm:-mt-[0.2em] sm:-mb-[0.15em]">
                        To help{" "}
                        <span className="text-foreground">{dog.dog_name}</span>{" "}
                        loose weight from their current weight of{" "}
                        <span className="text-foreground">
                          {dog.weight_metric}kg
                        </span>
                        , they should be fed{" "}
                    ...
                    {dog.ratios_intake !== 2.5 &&
                      ...
                      dog.ratios_intake !== 2 && (
                        <p className="sm:-mt-[0.2em] sm:-mb-[0.15em]">
                          ...
                          reach your custom goal, you should feed{" "}
                          <span className="whitespace-nowrap text-foreground">
                            {new Intl.NumberFormat().format(intakeGrams)}g
                          </span>{" "}
                          per day.
                    ...
                    <p className="">Total can be divided across meals.</p>
                  </>
                )}
              </div>
              <BadgeStack
                ...
                label={`${new Intl.NumberFormat().format(intakeGrams)}g`}
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-8 gap-x-4">
              <BadgeStack
                ...
                sublabel={`${new Intl.NumberFormat().format(
                  meatGrams
                )}g / ${Math.round(dog.ratios_muscle_meat * 100)}%`}
              />
              <BadgeStack
                variant="plant"
                ...
                sublabel={`${new Intl.NumberFormat().format(
                  plantGrams
                )}g / ${Math.round(dog.ratios_plant_matter * 100)}%`}
              />
              <BadgeStack
                variant="liver"
              ...
              <BadgeStack
                ...
                sublabel={`${new Intl.NumberFormat().format(
                  organGrams
                )}g / ${Math.round(dog.ratios_secreting_organ * 100)}%`}
              />
            </div>
          </CardContent>
        </Card>
